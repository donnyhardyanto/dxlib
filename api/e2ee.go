...
var OnE2EEPrekeyUnPack func(aepr *DXAPIEndPointRequest, prekeyIndex string, dataAsHexString string) (lvPayloadElements []*lv.LV, sharedKey2AsBytes []byte, edB0PrivateKeyAsBytes []byte, err error)
