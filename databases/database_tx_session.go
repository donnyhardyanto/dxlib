...
//
// Parameters:
//   - dbType: databases type (PostgreSQL, SQLServer, Oracle, MariaDB)
...
//   - sessionKey: the databases session config key name (e.g., "app.encryption_key")
...
func txSetSessionConfig(dtx *DXDatabaseTx, dbType base.DXDatabaseType, key string, value string) error {
	...
	case base.DXDatabaseTypeMariaDB:
		...
		return err
	default:
		return fmt.Errorf("unsupported databases type for TxSetSessionKey: %v", dbType)
	}
}
