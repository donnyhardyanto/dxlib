...
// ModelDBTDEConfig holds Transparent Data Encryption configuration for different databases types
// Each databases has different TDE approaches:
...
type ModelDBTDEConfig struct {
	...
	// SQLServer: Flag indicating that databases-level TDE should be enabled
...
// IsEnabled checks if TDE is configured for the specified databases type key
